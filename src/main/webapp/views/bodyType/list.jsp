...
<%
    request.setAttribute("pageScript", "ui/bodyTypesList.js");
            ...
            <div class="col-sm-12 card">
                ...
                <div class="card-body">
                    <ul class="nav navbar-nav">
                        <li><a class="btn btn-primary" href="<%=request.getContextPath()%>/body-types.do?id=0"><i class="fa fa-plus"></i> Добавить</a></li>
                    </ul>
